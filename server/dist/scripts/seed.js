...
const courseSchema = new mongoose_1.default.Schema({
    title: String,
    description: String,
    instructor: { type: mongoose_1.default.Schema.Types.ObjectId, ref: "User" },
    studentIds: [{ type: mongoose_1.default.Schema.Types.ObjectId, ref: "User" }],
    duration: String,
    level: String,
    category: String,
    rating: Number,
...
async function seedDatabase() {
    try {
        ...
        for (const instructor of instructors) {
            ...
            if (!existingUser) {
                const hashedPassword = await bcryptjs_1.default.hash(instructor.password, 10);
        ...
        const sampleCourse = (await Course.findOne().populate("instructor", "name email"));
